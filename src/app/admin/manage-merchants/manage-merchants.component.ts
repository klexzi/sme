...
@Component({
  ...
  selector: 'manage-merchants',
  templateUrl: './manage-merchants.component.html',
  styleUrls: ['./manage-merchants.component.css']
})
export class ManageMerchantsComponent implements OnInit {
  ...
  openDialog() {
    this.dialog.open(DeactivateDialogComponent);
  }
}
...
@Component({
  // tslint:disable-next-line:component-selector
  selector: 'dialog',
  template: `<h2 mat-dialog-title>Deactivate Merchant</h2>
